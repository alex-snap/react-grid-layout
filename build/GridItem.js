...
var GridItem = function (_React$Component) {
  ...
  GridItem.prototype.render = function render() {
    ...
    var newChild = _react2.default.cloneElement(child, {
      ...
      className: ['react-grid-item', child.props.className || '', this.props.className, this.props.static ? 'static' : '', this.props.container ? 'container' : '', this.state.resizing ? 'resizing' : '', this.state.dragging ? 'react-draggable-dragging' : '', useCSSTransforms ? 'cssTransforms' : ''].join(' '),
